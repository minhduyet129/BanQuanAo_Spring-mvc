...
<html lang="en">
    ...
    <head>
        ...
        <!-- MetisMenu CSS -->
        <link href="/views/assets/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="/views/assets/dist/css/sb-admin-2.css" rel="stylesheet">
    ...
    <body>
        ...
        <script src="/views/assets/vendor/metisMenu/metisMenu.min.js"></script>

        <!-- Custom Theme JavaScript -->
        <script src="/views/assets/dist/js/sb-admin-2.js"></script>
